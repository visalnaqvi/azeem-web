...
const Forex = () => {
    return (
        <>
            <Head>
                <title>Shia Qafila Hujj , Umrah , Ziyarat | FOREX</title>
            </Head>
