...
const Forex = () => {
    return (
        <>
            <Head>
                <title>Shia Qafila Hajj , Umrah , Ziyarat | FOREX</title>
            </Head>
