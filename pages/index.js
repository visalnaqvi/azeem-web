...
export default function Home() {
  ...
  return (
    ...
    <div>
      <Head>
        <title>Shia Qafila Hujj , Umrah , Ziyarat | Home</title>
      </Head>
      {
        size.width > 700 ?
