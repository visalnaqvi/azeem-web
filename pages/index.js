...
export default function Home() {
  ...
  return (
    ...
    <div>
      <Head>
        <title>Shia Kafla Hujj , Umrah , Ziyarat | Home</title>
      </Head>
      {
        size.width > 700 ?
